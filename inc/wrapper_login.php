...
if (isset($_POST['email'])) {
  ...
  $MM_redirectLoginSuccess = "my_dash.php";
...
<div class="container">
    <div class="col_2">
        <div class="formular_front" style="margin: 80px auto;">
            <form action="login.php" method="post" name="formsignup" id="formsignup">
                <table width="70%" align="center" cellspacing="0" class="list">
                    <tr valign="baseline" height="40">
                        <td style="" colspan="6" align="center" valign="middle"><h4>Log in HP10.</h4></td>      
                    </tr>
